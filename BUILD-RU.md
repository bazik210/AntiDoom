# Инструкция по сборке AntiDoom Win32 Port
...
После сборки запустите игру для проверки. При каждом запуске рядом с `antidoom.exe` формируется файл журнала:
```text
antidoom.log
```
...
Инструкция по запуску игры, выбору разрешения и управлению находится в [README-RU.md](README-RU.md) (или [README.md](README.md) на английском).
